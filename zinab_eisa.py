...
print(perform_2_sample_t_test(a_t1_list, b_t1_list)) #return: calculated p-value

a_t2_list = data_to_num_list(return_rate_a)
b_t2_list = data_to_num_list(return_rate_b)
# print(get_t_score(a_t2_list, b_t2_list))
# print(perform_2_sample_t_test(a_t2_list, b_t2_list)) #return: calculated p-value
c1_observed_grid = [a_t2_list, b_t2_list]
print(chi2_value(c1_observed_grid)) #associated chi^2 value of expected counts
print(perform_chi2_homogeneity_test(c1_observed_grid)) # calculated p-value
